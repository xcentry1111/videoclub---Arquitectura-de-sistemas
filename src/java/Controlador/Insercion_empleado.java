 ...
 * @author ficha1020611
 */
@WebServlet(name = "Insercion_empleado", urlPatterns = {"/Insercion_empleado"})
public class Insercion_empleado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (v == 0) {
                ...
                pre_login.setString(2, "Empleado");
            ...
            PreparedStatement pre = con.prepareStatement("INSERT INTO Empleados(nombre,apellido,tel,email,cargo,documento,fecha_inicio,user_id)VALUES(?,?,?,?,?,?,?,?)");
