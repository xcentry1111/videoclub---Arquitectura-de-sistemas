 ...
 * @author Marlon
 */
@WebServlet(name = "Guarda_edicion_cliente", urlPatterns = {"/Guarda_edicion_cliente"})
public class Guarda_edicion_cliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement pre = con.prepareStatement("update Clientes SET nombre=?, apellido=?, fecha_nacimiento=?, tel=?, email=?, Carnet_id=?, documento=?, ciudad=?, direccion=?, user_id=? where id=?");
            ...
            if (!request.getParameter("nombre").equals("") && !request.getParameter("apellido").equals("")
                ...
                pre.setString(10, id_u);
                pre.setString(11, temp[0]);
