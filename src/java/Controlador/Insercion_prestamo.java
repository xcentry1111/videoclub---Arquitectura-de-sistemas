 ...
 * @author Marlon
 */
@WebServlet(name = "Insercion_prestamo", urlPatterns = {"/Insercion_prestamo"})
public class Insercion_prestamo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement pre = con.prepareStatement("INSERT INTO Prestamos(Cliente_id,Pelicula_id,fecha_devolucion,pago,Empleado_id)VALUES(?,?,?,?,?)");
