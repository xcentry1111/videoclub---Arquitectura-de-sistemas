...
public class Eliminar_cliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String con_u = "select user_id from Clientes where id='" + id + "'";
            ...
            //Este para borrar Cliente
            PreparedStatement Stm = nuevaConex.prepareStatement("delete from Clientes where id=?");
