    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String contar = "select Clientes.id,Clientes.nombre,Clientes.apellido,Clientes.fecha_nacimiento,\n"
                    + "Clientes.tel,Clientes.email,Carnets.Numero, Clientes.documento,Clientes.ciudad,Clientes.direccion,Users.Usuario \n"
            ...
            while (res.next()) {
                ...
                obj_car.setNumero(Integer.parseInt(res.getString(7)));
            ...
            response.sendRedirect("ver_cliente.jsp");
